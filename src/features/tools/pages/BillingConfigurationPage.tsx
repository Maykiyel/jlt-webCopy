  ...
  const createMutation = useMutation({
    ...
    onMutate: async (payload) => {
      ...
      queryClient.setQueryData(
        ["billing-configs"],
        (current: { data?: Record<BillingConfigType, BillingConfigResource[]> } | undefined) => {
      ...
      queryClient.setQueryData(
        ...
        (current: { data?: Record<BillingConfigType, BillingConfigResource[]> } | undefined) => {
          ...
          return {
            ...
            data: {
              ...current.data,
              "RECEIPT CHARGES": (current.data["RECEIPT CHARGES"] ?? []).map((item) =>
        ...
        (current: { data?: Record<BillingConfigType, BillingConfigResource[]> } | undefined) => {
          ...
          return {
            ...
            data: {
              ...
              CURRENCY: (current.data.CURRENCY ?? []).filter((item) => item.id !== id),
