...
This repository uses a feature-first architecture designed for scalability,
clear ownership, and safe refactoring.
...
If reuse is needed across features, move that logic to a shared module instead
of importing another feature directly.
...
1. If API contracts are heavily shared across many features, a dedicated global
   API module can be used.
...
1. Compose flow should stay modular:
   - page/container owns orchestration
   - step views live in compose components
